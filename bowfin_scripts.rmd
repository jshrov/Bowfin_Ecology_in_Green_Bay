...
# femaleUMR
806.8 * (1-exp(-0.227*(2 + 0.012)))
806.8 * (1-exp(-0.227*(5 + 0.012)))
#maleUMR 
696.7 * (1-exp(-0.328 * (2 - 0.185)))
696.7 * (1-exp(-0.328 * (5 - 0.185)))

# Lake Lindsay Grace
603.8 * (1-exp(-0.625 * (2 - 0.779)))
603.8 * (1-exp(-0.625 * (5 - 0.779)))

# Upper Barataria Estuary
1131.6 * (1-exp(-0.078 * (2 - 3.523)))
1131.6 * (1-exp(-0.078 * (5 - 3.523)))

# Pool 11 UMR
809.2 * (1-exp(-0.229 * (2 - 0.086)))
809.2 * (1-exp(-0.229 * (5 - 0.086)))

# Pool 13 UMR
783.3 * (1-exp(-0.235 * (2 + 0.004)))
783.3 * (1-exp(-0.235 * (5 + 0.004)))
```
